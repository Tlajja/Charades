package com.tlajja.charades.game
...
import com.tlajja.charades.data.Category
import com.tlajja.charades.data.CustomCategoryRepository
import com.tlajja.charades.data.GameMode
import com.tlajja.charades.data.GameResult
import com.tlajja.charades.data.Player
...
class GameViewModel(
    ...
    fun getNextWord() {
        ...
        if (allWords.isEmpty()) {
            gameState = gameState.copy(currentWord = "Nėra žodžių!")
            return
        }
